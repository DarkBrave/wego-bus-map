...
def main():
    ...
    parser.add_argument("--out", default="gtfs_weekday_grid.csv")
    args = parser.parse_args()

    trips, stop_times, calendar = load_gtfs(args.gtfs_folder)

    print("Building weekday GTFS 5-minute grid...")
